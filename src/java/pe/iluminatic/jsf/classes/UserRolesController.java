...
import pe.iluminatic.session.beans.UserRolesFacade;
...
public class UserRolesController implements Serializable {
    ...
    @EJB
    private pe.iluminatic.session.beans.UserRolesFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("UserRolesCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("UserRolesUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("UserRolesDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class UserRolesControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof UserRoles) {
                ...
                return getStringKey(o.getUserRoleId());
            } else {
